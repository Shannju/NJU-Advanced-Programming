...
student::student(int health, int clever, int mental) : health(health),
    clever(clever),
    mental(mental)
{}
...
student::student(GraphScene *s, const QString &icon, int side, int i, int j) : student(s,icon,side,i,j)
{
    this->dir=pair(1,0);
}
